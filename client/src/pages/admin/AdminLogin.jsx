    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 40 }}>
          ...
          <div>
            <div className="serif" style={{ fontSize: 20, fontWeight: 500, lineHeight: 1 }}>
              My Space Hotels
            </div>
            <div style={{ fontSize: 9, letterSpacing: "0.3em", color: theme.SEA_DARK, marginTop: 2 }}>
              ADMIN PORTAL
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          <div style={{ fontSize: 11, letterSpacing: "0.3em", color: theme.SEA_DARK, textTransform: "uppercase" }}>
            Restricted Access
          </div>
        </div>

        <h1 className="serif" style={{ fontSize: 36, fontWeight: 400, marginBottom: 32, lineHeight: 1.1 }}>
          Admin Sign In
        </h1>
