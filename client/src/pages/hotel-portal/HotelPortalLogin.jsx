...
export default function HotelPortalLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // RBAC CHECK
      if (
        roleData.role !== "hotel_admin" &&
        roleData.role !== "super_admin"
      ) {
        await signOut();

        throw new Error(
          "Unauthorized access. Hotel partner account required."
        );
      }
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            manage bookings, update
            photos, and track revenue —
            all in one place.
          </p>
